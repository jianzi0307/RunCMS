...
insert  into `app_config`(`id`,`name`,`type`,`title`,`group`,`extra`,`remark`,`create_time`,`update_time`,`status`,`value`,`sort`) values (1,'APP_NAME',1,'站点标题',1,'','网站或应用标题,前台显示',1445922713,1445922713,1,'网站管理系统2',0),(2,'CONFIG_TYPE_LIST',3,'配置数据类型',3,'','主要用于数据解析和页面表单的生成',1445920122,1445920122,1,'0:数字\r\n1:字符\r\n2:文本\r\n3:数组\r\n4:枚举\r\n5:图片',0),(3,'CONFIG_GROUP_LIST',3,'配置分组',3,'','配置分组',1445920112,1445920112,1,'1:基本设置\r\n2:风格设置\r\n3:系统设置',0),(332,'PAGE_SCREEN_STYLE',4,'页面风格',2,'0:宽屏\n1:窄屏','页面宽窄风格',1445920353,1445920353,1,'0',0),(333,'PAGE_HEADER_FIXED',4,'页面头部',2,'0:默认\n1:固定','页头是否固定悬浮',1445920560,1445920560,1,'0',0),(334,'PAGE_FOOTER_FIXED',4,'页面底部',2,'0:默认\n1:固定','页面底部是否固定悬浮',1445920550,1445920550,1,'0',0),(5,'APP_COPYRIGHT',1,'版权信息',1,'','版权信息，前端显示在页脚',1438219932,1438219932,1,'2015 RunCms',0),(4,'APP_IPC',1,'备案信息',1,'','备案信息，前端显示在页脚',1438666455,1438666455,1,'沪ICP备12007941号',0),(335,'SITE_BACKEND_LOGO',5,'后台LOGO',1,'','后台LOGO',1445922919,1445922919,1,'/uploads/2015-10-29/5631b42eaf111.png',0),(336,'PAGE_COLOR_STYLE',4,'页面色调',2,'0:暗黑\n1:青淡','后台颜色风格',1446098005,1446098005,1,'1',0);
